...
$string['allcourses'] = 'All my courses';
...
$string['nopinned'] = 'You haven\'t pinned any courses yet. To pin a course, click the <strong><i class="fa fa-thumb-tack"></i> Pin</strong> icon next to a course.';
$string['next30days'] = 'Next 30 days';
$string['next7days'] = 'Next 7 days';
$string['past'] = 'Past';
$string['pinnedcourses'] = 'Pinned Courses';
