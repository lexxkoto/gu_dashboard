 ...
 * given day range.
 *
 * @module     block_gu_dashboard/event_list
...
define(['jquery', 'core/notification', 'core/templates',
        ...
        'block_gu_dashboard/calendar_events_repository'],
    ...
    var TEMPLATES = {
        EVENT_LIST_ITEMS: 'block_gu_dashboard/event-list-items',
        COURSE_EVENT_LIST_ITEMS: 'block_gu_dashboard/course-event-list-items'
    };
