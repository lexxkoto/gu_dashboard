...
class courses_view implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        foreach ($this->courses as $course) {
            ...
            if($course->pinned) {
                $exportedcourse->pinlink = '<a class="pin-icon pinned" title="Unpin this course" href="'.$CFG->wwwroot.'/blocks/gu_dashboard/pinned.php?id='.$course->id.'&action=unpin"><i class="fa fa-thumb-tack"></i></a>';
            } else {
                $exportedcourse->pinlink = '<a class="pin-icon unpinned" title="Pin this course" href="'.$CFG->wwwroot.'/blocks/gu_dashboard/pinned.php?id='.$course->id.'&action=pin"><i class="fa fa-thumb-tack"></i></a>';
            }
